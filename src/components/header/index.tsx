  ...
  return (
    <HeaderWrapper>
      <div className="flex items-center justify-between py-3">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center w-[50px] cursor-pointer">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <Drawer
          ...
          width={500}
        >
          <div className="search-menu text-center">
            <input className="text-[15px] ps-2 w-full" placeholder="Search" />
            <Button variant="contained" className="btn mt-1 w-full">
              Search
            </Button>
          </div>
